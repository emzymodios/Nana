...
local MoreTab = safeLoad("https://raw.githubusercontent.com/emzymodios/Nana/refs/heads/main/Scripts/ui/tabs/more_tab.lua")
...
function UI.Init()
    ...
    local tmrCorner = Instance.new("UICorner")
    tmrCorner.CornerRadius = UDim.new(0, 8)
    tmrCorner.Parent = tabMoreBtn
